class PortfolioManager {
    ...
    initCarousels() {
        this.setupCarousel('projects-scroll-wrapper', 'projects-grid');
        this.setupCarousel('blog-scroll-wrapper', 'blog-grid');
    }

    setupCarousel(wrapperId, gridId) {
